...
data_loading_and_xmatching.perform_xmatch(Astrogeo_catalogue,DESI_catalogue,'DESI','RA','DEC')
data_loading_and_xmatching.perform_xmatch(Astrogeo_catalogue,SDSS_catalogue,'SDSS','ra','dec')
data_loading_and_xmatching.perform_xmatch(Astrogeo_catalogue,DES_catalogue,'DES','DES_full_catalogue_Astrogeo_matches_RA','DES_full_catalogue_Astrogeo_matches_DEC')
data_loading_and_xmatching.perform_xmatch(Astrogeo_catalogue,Skymapper_catalogue,'Skymapper','ra','dec')
data_loading_and_xmatching.perform_xmatch(Astrogeo_catalogue,KIDS_catalogue,'KIDS','RAJ2000','DECJ2000')
